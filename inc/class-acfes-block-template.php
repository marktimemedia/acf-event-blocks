...
*/
if ( ! class_exists( 'Acfes_Block_Templates' ) ) {

	class Acfes_Block_Templates {
		...
		*/
		...
		public static function get_instance() {
			...
			if ( null === self::$instance ) {
				self::$instance = new Acfes_Block_Templates();
			}
		...
		private function __construct() {
			...
			if ( version_compare( floatval( get_bloginfo( 'version' ) ), '4.7', '<' ) ) {
					...
					add_filter(
						...
						array( $this, 'acfes_register_project_block_templates' )
					);
					...
					add_filter(
						...
						array( $this, 'acfes_add_new_block_template' )
					);
			}
			...
			add_filter(
				'template_include',
				array( $this, 'acfes_view_project_block_template' )
			);
		 ...
		 *
		 */
		public function acfes_add_new_block_template( $posts_templates ) {
			$new_templates   = apply_filters( 'acfes_filter_block_templates', $this->templates );
		...
		public function acfes_register_project_block_templates( $atts ) {
		 ...
		 */
		public function acfes_view_project_block_template( $template ) {
